        ...
        for (final AssetModel asset : assets) {
            ...
            if (groupAssetRenditionsByFolder) {
                ...
                try {
                    ...
                    throw new AssetRenditionException("Could not add Folder as Zip Entry", e);
                }
            }
                ...
                try {
                    ...
                    if (stream != null && stream.getOutputStream() != null) {
                        try {
                            ...
                            throw new AssetRenditionException("Unable to close an AssetRendition output stream", e);
                        }
                    }
                }
            }
