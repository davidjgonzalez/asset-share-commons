...
@Component(
        ...
        property = {
                "sling.servlet.resourceTypes=asset-share-commons/data-sources/search-providers",
                "sling.servlet.methods=GET"
        },
        configurationPolicy = ConfigurationPolicy.REQUIRE
)
public class SearchProvidersDataSource extends SlingSafeMethodsServlet {
    @Reference
    ...
    protected final void doGet(final SlingHttpServletRequest request, final SlingHttpServletResponse response) {
        ...
        for (final SearchProvider searchProvider : searchProviders) {
            data.put(StringUtils.capitalize(searchProvider.getId()), searchProvider.getId());
        }
