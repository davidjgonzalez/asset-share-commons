...
--spectrum-alias-infieldbutton-fill-loudnessHigh-background-color-key-focus
);--spectrum-alias-infieldbutton-fill-loudnessLow-background-color-disabled:transparent;--spectrum-alias-track-color-default:var(--spectrum-global-color-gray-300);--spectrum-alias-tabitem-text-color-default:var(
...
--spectrum-global-color-indigo-500
);--spectrum-alias-assetcard-overlay-background-color:rgba(109,115,246,.2);--spectrum-alias-assetcard-border-color-selected:var(
--spectrum-global-color-indigo-500
...
)}:host,:root{--spectrum-colorslider-height:var(--spectrum-global-dimension-size-200);--spectrum-colorslider-vertical-width:var(--spectrum-colorslider-height);--spectrum-colorslider-border-radius:var(
...
);--spectrum-slider-track-thickness:4px;--spectrum-slider-handle-gap:0px;--spectrum-in-field-button-fill-stacked-inner-border-rounding:1px;--spectrum-in-field-button-edge-to-fill:4px;--spectrum-in-field-button-stacked-inner-edge-to-fill:1px;--spectrum-in-field-button-outer-edge-to-disclosure-icon-stacked-medium:5px;--spectrum-in-field-button-outer-edge-to-disclosure-icon-stacked-large:7px;--spectrum-in-field-button-outer-edge-to-disclosure-icon-stacked-extra-large:8px;--spectrum-in-field-button-inner-edge-to-disclosure-icon-stacked-small:1px;--spectrum-in-field-button-inner-edge-to-disclosure-icon-stacked-medium:1px;--spectrum-in-field-button-inner-edge-to-disclosure-icon-stacked-large:3px;--spectrum-in-field-button-inner-edge-to-disclosure-icon-stacked-extra-large:4px;--spectrum-border-width-100:2px;--spectrum-accent-color-100:var(--spectrum-indigo-100);--spectrum-accent-color-200:var(--spectrum-indigo-200);--spectrum-accent-color-300:var(--spectrum-indigo-300);--spectrum-accent-color-400:var(--spectrum-indigo-400);--spectrum-accent-color-500:var(--spectrum-indigo-500);--spectrum-accent-color-600:var(--spectrum-indigo-600);--spectrum-accent-color-700:var(--spectrum-indigo-700);--spectrum-accent-color-800:var(--spectrum-indigo-800);--spectrum-accent-color-900:var(--spectrum-indigo-900);--spectrum-accent-color-1000:var(--spectrum-indigo-1000);--spectrum-accent-color-1100:var(--spectrum-indigo-1100);--spectrum-accent-color-1200:var(--spectrum-indigo-1200);--spectrum-accent-color-1300:var(--spectrum-indigo-1300);--spectrum-accent-color-1400:var(--spectrum-indigo-1400);--spectrum-heading-sans-serif-font-weight:var(
--spectrum-black-font-weight
...
--spectrum-gray-300
);--system-spectrum-actionbutton-border-color-default:transparent;--system-spectrum-actionbutton-border-color-hover:transparent;--system-spectrum-actionbutton-border-color-down:transparent;--system-spectrum-actionbutton-border-color-focus:transparent;--system-spectrum-actionbutton-background-color-disabled:var(
--spectrum-disabled-background-color
);--system-spectrum-actionbutton-border-color-disabled:transparent;--system-spectrum-actionbutton-content-color-disabled:var(
...
);--system-spectrum-actionbutton-staticblack-selected-mod-actionbutton-border-color-disabled:transparent;--system-spectrum-actionbutton-staticwhite-background-color-default:var(
--spectrum-transparent-white-200
...
--spectrum-disabled-background-color
);--system-spectrum-button-border-color-disabled:transparent;--system-spectrum-button-content-color-disabled:var(
--spectrum-disabled-content-color
...
--spectrum-gray-900
);--system-spectrum-switch-handle-border-color-down:var(--spectrum-gray-900);--system-spectrum-switch-handle-border-color-focus:var(
--spectrum-gray-900
...
--spectrum-component-height-200
);--system-spectrum-tag-background-color:transparent;--system-spectrum-tag-background-color-hover:var(--spectrum-gray-300);--system-spectrum-tag-background-color-active:var(--spectrum-gray-400);--system-spectrum-tag-background-color-focus:var(--spectrum-gray-300);--system-spectrum-tag-content-color:var(
--spectrum-neutral-content-color-default
...
--spectrum-disabled-border-color
);--system-spectrum-tag-background-color-disabled:transparent;--system-spectrum-tag-size-small-spacing-inline-start:var(
